...
computers = Topic.create(title: "Computers", description: "Tech stuff and whatnot")
animals = Topic.create(title: "Animals", description: "Animals are neat")

tom.scores.create(score: 1000, topic: computers)
angelica.scores.create(score: 7900, topic: computers)
phil.scores.create(score: 0, topic: computers)
