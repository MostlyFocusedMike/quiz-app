...
sarah.scores.create(score: 2100, topic: film)
caroline.scores.create(score: 1600, topic: film)
greg.scores.create(score: 2300, topic: tv)
angelica.scores.create(score: 1500, topic: tv)
phil.scores.create(score: 2200, topic: tv)
tom.scores.create(score: 3000, topic: computers)
patty.scores.create(score: 2700, topic: computers)
caroline.scores.create(score: 2500, topic: computers)
